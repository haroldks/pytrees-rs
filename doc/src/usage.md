...
Commands:
  ...
  d2  Optimal depth 2 algorithms using Error or Information as criterion
...
- [d2](#learning-depth-2-optimal-decision-trees): Generate only optimal decision trees with a depth of 2, using either classification error or information gain as the cost function.
...
```dtrees-rs d2 --help
Usage: dtrees-rs --input <INPUT> d2 [OPTIONS]
