use crate::searches::{DiscrepancyStrategy, SearchHeuristic};
use crate::tree::Tree;
use clap::Parser;
...
pub struct ExampleParser {
    ...
    #[arg(long, value_enum, default_value_t = DiscrepancyStrategy::Exponential)]
    pub discrepancy: DiscrepancyStrategy,
