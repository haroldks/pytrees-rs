...
#[pyclass]
pub struct PyLDSDl85 {
    learner: LDSDL85<Trie, dyn Discrepancy + Send + Sync, dyn ErrorWrapper + Send + Sync,  dyn Heuristic + Send + Sync>,
    pub(crate) error: f64,
...
impl PyLDSDl85 {
    ...
    pub fn new(
        ...
        let search_strategy = match discrepancy_strategy {
            ExposedDiscrepancyStrategy::Monotonic => SearchStrategy::DiscrepancySearchMonotonic,
            ExposedDiscrepancyStrategy::Exponential => SearchStrategy::DiscrepancySearchExponential,
            ExposedDiscrepancyStrategy::Luby => SearchStrategy::DiscrepancySearchLuby,
        };
